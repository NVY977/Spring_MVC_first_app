package ru.nvy.springmvc.config;
 ...
 * @author NVY
 */
//Реализуем интерефейс WebMvcConfigurer потому что мы хотим настроить SpringMvc под свои нужды
@Configuration
@ComponentScan("ru.nvy.springmvc")
@EnableWebMvc
public class SpringConfig implements WebMvcConfigurer {
    ...
    // используем applicationContext для настройки нашего Thymeleaf
    @Bean
    public SpringResourceTemplateResolver templateResolver() {
        SpringResourceTemplateResolver templateResolver = new SpringResourceTemplateResolver();
        templateResolver.setApplicationContext(applicationContext);
        templateResolver.setPrefix("/WEB-INF/views/"); // задаем папку где лежат наши представления
